...
class AndroidPersistenceDriver (
    ...
    override fun set(key: String, value: String) { defaultSharedPreferences.edit().putString(key, value).apply() }
    override fun set(key: String, value: Long) { defaultSharedPreferences.edit().putLong(key, value).apply() }
    override fun set(key: String, value: Int) { defaultSharedPreferences.edit().putInt(key, value).apply() }
    ...
    override fun secureSet(id: SteamId, key: String, value: String) { secureSharedPreferences.edit().putString(idKey(id, key), value).apply() }
    ...
    override fun secureContainsIdentity(id: SteamId): Boolean = secureSharedPreferences.getBoolean(idKey(id, "_persist"), false)
