            ...
            entry.entries.forEach { feature ->
                when (feature) {
                    ...
                    EAppFeature.PartialControllerSupport -> {
                        app.common.controllerSupport.equals(EAppControllerSupportLevel.Full.name, ignoreCase = true) || categories.contains(28) || app.common.controllerSupport.equals(EAppControllerSupportLevel.Partial.name, ignoreCase = true) || categories.contains(18)
                    }
